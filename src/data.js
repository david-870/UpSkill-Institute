...
export const STATS = [
  ...
  { target: 120, prefix: '', label: 'Seats per course — real competition, real payout' },
]
...
export const STEPS = [
  ...
  { n: '02', title: 'Choose one career track', text: 'Ethical Hacking, AI & Automation, Digital Marketing, or Business & Sales.' },
  ...
  { n: '04', title: 'Decide, then pay your track\'s fee', text: 'No pressure before day 7. Enroll only once you\'re sure — fees range from ₦30,000 to ₦45,000.' },
  { n: '05', title: 'Get placed in your class', text: 'Private group, capped at 120 students, matched to your chosen course.' },
...
export const COURSES = [
  ...
  { title: 'Branding, Sales & Business Management', price: '₦40,000', color: '#33D6A6', desc: 'Branding, Sales & Business Management teaches you how to build a strong brand, attract customers, and grow a successful business. Learn how to sell with confidence, manage business operations, and increase profits. These skills are essential for entrepreneurs, business owners, and future business leaders.' },
]
